...
### Вариант #73 ###
**Разработать программу, которая считывает с клавиатуры список слов, приводит их к нижнему регистру и сортирует в обратном лексикографическом порядке. Пользоваться стандартными функциями сортировки и работы со строками запрещается - необходимо их реализовать вручную.**
